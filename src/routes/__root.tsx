...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vardhman Medicare — Book doctors, in-person or online" },
      { name: "description", content: "Vardhman Medicare is a premium clinic consultation platform for booking in-person and online appointments with trusted doctors." },
      { property: "og:title", content: "Vardhman Medicare — Book doctors, in-person or online" },
      { property: "og:description", content: "Vardhman Medicare is a premium clinic consultation platform for booking in-person and online appointments with trusted doctors." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Vardhman Medicare — Book doctors, in-person or online" },
      { name: "twitter:description", content: "Vardhman Medicare is a premium clinic consultation platform for booking in-person and online appointments with trusted doctors." },
